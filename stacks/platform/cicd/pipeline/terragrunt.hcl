...
dependency "ecr" {
  ...
  mock_outputs = {
    ...
    signing_profile_arn = "arn:aws:signer:us-east-1:123456789012:/signing-profiles/platform_mock"
  }
...
inputs = {
  ...
  signing_profile_arn = dependency.ecr.outputs.signing_profile_arn
